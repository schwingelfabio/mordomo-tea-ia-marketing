...
import { ConnectedAccount, PublicationQueueItem } from '../types';
import { Play, Calendar, Zap, FileText, Video, Image as ImageIcon } from 'lucide-react';
...
export const PublicationDashboard: React.FC<Props> = ({ accounts, queue, onGenerate }) => {
  return (
    <div className="space-y-6">
      <NetworkStatus accounts={accounts} />
      
      <div className="flex gap-4">
        <button className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-teal-600 rounded-lg font-bold hover:bg-teal-500">
          <Zap size={20} /> GERAR E PUBLICAR
        </button>
